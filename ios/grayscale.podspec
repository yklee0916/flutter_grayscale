Pod::Spec.new do |s|
  s.name             = 'grayscale'
  s.version          = '0.0.1'
  s.summary          = 'Flutter plugin for CoreImage-based grayscale conversion on iOS.'
  s.description      = <<-DESC
Converts images to grayscale using CoreImage with a GPU/Metal-backed CIContext on iOS.
  DESC
